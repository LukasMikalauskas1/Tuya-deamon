...
#define THING_TYPE_ID2STR(S) \
    ((S) == THING_TYPE_MODEL_GET ? "THING_TYPE_MODEL_GET" : ((S) == THING_TYPE_MODEL_RSP ? "THING_TYPE_MODEL_RSP" : ((S) == THING_TYPE_PROPERTY_REPORT ? "THING_TYPE_PROPERTY_REPORT" : ((S) == THING_TYPE_PROPERTY_REPORT_RSP ? "THING_TYPE_PROPERTY_REPORT_RSP" : ((S) == THING_TYPE_PROPERTY_SET ? "THING_TYPE_PROPERTY_SET" : ((S) == THING_TYPE_PROPERTY_SET_RSP ? "THING_TYPE_PROPERTY_SET_RSP" : ((S) == THING_TYPE_PROPERTY_DESIRED_GET ? "THING_TYPE_PROPERTY_DESIRED_GET" : ((S) == THING_TYPE_PROPERTY_DESIRED_GET_RSP ? "THING_TYPE_PROPERTY_DESIRED_GET_RSP" : ((S) == THING_TYPE_PROPERTY_DESIRED_DEL ? "THING_TYPE_PROPERTY_DESIRED_DEL" : ((S) == THING_TYPE_PROPERTY_DESIRED_DEL_RSP ? "THING_TYPE_PROPERTY_DESIRED_DEL_RSP" : ((S) == THING_TYPE_EVENT_TRIGGER ? "THING_TYPE_EVENT_TRIGGER" : ((S) == THING_TYPE_EVENT_TRIGGER_RSP ? "THING_TYPE_EVENT_TRIGGER_RSP" : ((S) == THING_TYPE_ACTION_EXECUTE ? "THING_TYPE_ACTION_EXECUTE" : ((S) == THING_TYPE_ACTION_EXECUTE_RSP ? "THING_TYPE_ACTION_EXECUTE_RSP" : ((S) == THING_TYPE_BATCH_REPORT ? "THING_TYPE_BATCH_REPORT" : ((S) == THING_TYPE_BATCH_REPORT_RSP ? "THING_TYPE_BATCH_REPORT_RSP" : ((S) == THING_TYPE_DEVICE_SUB_BIND ? "THING_TYPE_DEVICE_SUB_BIND" : ((S) == THING_TYPE_DEVICE_SUB_BIND_RSP ? "THING_TYPE_DEVICE_SUB_BIND_RSP" : ((S) == THING_TYPE_DEVICE_SUB_LOGIN ? "THING_TYPE_DEVICE_SUB_LOGIN" : ((S) == THING_TYPE_DEVICE_SUB_LOGOUT ? "THING_TYPE_DEVICE_SUB_LOGOUT" : ((S) == THING_TYPE_DEVICE_TOPO_ADD ? "THING_TYPE_DEVICE_TOPO_ADD" : ((S) == THING_TYPE_DEVICE_TOPO_ADD_RSP ? "THING_TYPE_DEVICE_TOPO_ADD_RSP" : ((S) == THING_TYPE_DEVICE_TOPO_DEL ? "THING_TYPE_DEVICE_TOPO_DEL" : ((S) == THING_TYPE_DEVICE_TOPO_DEL_RSP ? "THING_TYPE_DEVICE_TOPO_DEL_RSP" : ((S) == THING_TYPE_DEVICE_TOPO_GET ? "THING_TYPE_DEVICE_TOPO_GET" : ((S) == THING_TYPE_DEVICE_TOPO_GET_RSP ? "THING_TYPE_DEVICE_TOPO_GET_RSP" : ((S) == THING_TYPE_OTA_FIRMWARE_REPORT ? "THING_TYPE_OTA_FIRMWARE_REPORT" : ((S) == THING_TYPE_OTA_ISSUE ? "THING_TYPE_OTA_ISSUE" : ((S) == THING_TYPE_OTA_GET ? "THING_TYPE_OTA_GET" : ((S) == THING_TYPE_OTA_GET_RSP ? "THING_TYPE_OTA_GET_RSP" : ((S) == THING_TYPE_OTA_PROGRESS_REPORT ? "THING_TYPE_OTA_PROGRESS_REPORT" : ((S) == THING_TYPE_EXT_TIME_REQUEST ? "THING_TYPE_EXT_TIME_REQUEST" : ((S) == THING_TYPE_EXT_TIME_RESPONSE ? "THING_TYPE_EXT_TIME_RESPONSE" : ((S) == THING_TYPE_EXT_CONFIG_GET ? "THING_TYPE_EXT_CONFIG_GET" : ((S) == THING_TYPE_EXT_CONFIG_GET_RSP ? "THING_TYPE_EXT_CONFIG_GET_RSP" : ((S) == THING_TYPE_EXT_FILE_UPLOAD_REQUEST ? "THING_TYPE_EXT_FILE_UPLOAD_REQUEST" : ((S) == THING_TYPE_EXT_FILE_UPLOAD_RESPONSE ? "THING_TYPE_EXT_FILE_UPLOAD_RESPONSE" : ((S) == THING_TYPE_EXT_FILE_DOWNLOAD_REQUEST ? "THING_TYPE_EXT_FILE_DOWNLOAD_REQUEST" : ((S) == THING_TYPE_EXT_FILE_DOWNLOAD_RESPONSE ? "THING_TYPE_EXT_FILE_DOWNLOAD_RESPONSE" : ((S) == THING_TYPE_CHANNEL_RAW_UP ? "THING_TYPE_CHANNEL_RAW_UP" : ((S) == THING_TYPW_CHANNEL_RAW_DOWN ? "THING_TYPW_CHANNEL_RAW_DOWN" : ((S) == THING_TYPE_CHANNEL_RPC_REQUEST ? "THING_TYPE_CHANNEL_RPC_REQUEST" : ((S) == THING_TYPE_CHANNEL_RPC_RESPONSE ? "THING_TYPE_CHANNEL_RPC_RESPONSE" : ((S) == THING_TYPE_DEVICE_TAG_REPORT ? "THING_TYPE_DEVICE_TAG_REPORT" : ((S) == THING_TYPE_DEVICE_TAG_REPORT_RESPONSE ? "THING_TYPE_DEVICE_TAG_REPORT_RESPONSE" : ((S) == THING_TYPE_DEVICE_TAG_GET ? "THING_TYPE_DEVICE_TAG_GET" : ((S) == THING_TYPE_DEVICE_TAG_GET_RESPONSE ? "THING_TYPE_DEVICE_TAG_GET_RESPONSE" : ((S) == THING_TYPE_DEVICE_TAG_DELETE ? "THING_TYPE_DEVICE_TAG_DELETE" : ((S) == THING_TYPE_DEVICE_TAG_DELETE_RESPONSE ? "THING_TYPE_DEVICE_TAG_DELETE_RESPONSE" : "Unknown")))))))))))))))))))))))))))))))))))))))))))))))))
